...
export const moduleRegistry = [
  ...
  {id:"inventory",name:"Inventory Management System",shortName:"IMS",labelKey:"inventory",description:"Manage inventory assets, user assignments, and valuation.",icon:PackageSearch,route:"/inventory",status:"active",permission:"can_access_inventory",category:"Assets",sidebarGroup:"logistics",sidebarGroupOrder:1},
