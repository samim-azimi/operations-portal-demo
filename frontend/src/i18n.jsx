...
const fr = {
  ...
  dashboards:"Tableaux de bord",myAssets:"Mes actifs",assetForm:"Fiche d'actifs",stockCards:"Fiches de stock",stockMovements:"Mouvements",stockReports:"Rapports de stock",allRequests:"Toutes les demandes",categories:"Catégories",importData:"Importer",
...
const fa = {
  ...
  dashboards:"داشبوردها",myAssets:"دارایی‌های من",assetForm:"فورم دارایی",stockCards:"کارت‌های موجودی",stockMovements:"حرکات",stockReports:"گزارش‌های موجودی",allRequests:"همه درخواست‌ها",categories:"دسته‌بندی‌ها",importData:"وارد کردن",
...
const ps = {
  ...
  dashboards:"ډشبورډونه",myAssets:"زما شتمنۍ",assetForm:"د شتمنۍ فورمه",stockCards:"د توکو کارتونه",stockMovements:"حرکتونه",stockReports:"د توکو راپورونه",allRequests:"ټولې غوښتنې",categories:"کټګورۍ",importData:"واردول",
